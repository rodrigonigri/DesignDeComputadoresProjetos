...
ARCHITECTURE structure OF aula2atv1 IS
...
-- Equation(s):
-- \memROM~0_combout\ = (!\Endereco[3]~input_o\ & (!\Endereco[4]~input_o\ & (!\Endereco[1]~input_o\ $ (!\Endereco[2]~input_o\))))
...
-- Equation(s):
-- \memROM~1_combout\ = ( !\Endereco[9]~input_o\ & ( (!\Endereco[5]~input_o\ & (!\Endereco[6]~input_o\ & (!\Endereco[7]~input_o\ & !\Endereco[8]~input_o\))) ) )
...
PORT MAP (
	...
	datad => \ALT_INV_Endereco[8]~input_o\,
	datae => \ALT_INV_Endereco[9]~input_o\,
	combout => \memROM~1_combout\);

\memROM~2\ : cyclonev_lcell_comb
-- Equation(s):
-- \memROM~2_combout\ = (\memROM~0_combout\ & \memROM~1_combout\)
...
-- Equation(s):
-- \memROM~3_combout\ = ( \memROM~1_combout\ & ( (!\Endereco[1]~input_o\ & (\Endereco[2]~input_o\ & (!\Endereco[3]~input_o\ & !\Endereco[4]~input_o\))) ) )
...
-- Equation(s):
-- \memROM~8_combout\ = ( \memROM~1_combout\ & ( !\Endereco[4]~input_o\ & ( (!\Endereco[3]~input_o\ & (!\Endereco[1]~input_o\ & ((!\Endereco[0]~input_o\) # (\Endereco[2]~input_o\)))) ) ) )
...
-- Equation(s):
-- \memROM~7_combout\ = ( \memROM~1_combout\ & ( !\Endereco[4]~input_o\ & ( (!\Endereco[3]~input_o\ & ((!\Endereco[1]~input_o\ & ((\Endereco[0]~input_o\))) # (\Endereco[1]~input_o\ & (!\Endereco[2]~input_o\ & !\Endereco[0]~input_o\)))) ) ) )

-- pragma translate_off
GENERIC MAP (
	extended_lut => "off",
	lut_mask => "0000000000000000000010001010000000000000000000000000000000000000",
	shared_arith => "off")
-- pragma translate_on
PORT MAP (
	dataa => \ALT_INV_Endereco[3]~input_o\,
...
-- Equation(s):
-- \memROM~4_combout\ = ( \memROM~1_combout\ & ( !\Endereco[0]~input_o\ & ( (!\Endereco[1]~input_o\ & (!\Endereco[2]~input_o\ & (!\Endereco[3]~input_o\ & !\Endereco[4]~input_o\))) ) ) )
...
-- Equation(s):
-- \memROM~5_combout\ = (!\Endereco[3]~input_o\ & (!\Endereco[4]~input_o\ & ((!\Endereco[1]~input_o\) # (!\Endereco[2]~input_o\))))
...
-- Equation(s):
-- \memROM~6_combout\ = (\memROM~1_combout\ & \memROM~5_combout\)
...
-- pragma translate_on
PORT MAP (
	dataa => \ALT_INV_memROM~1_combout\,
	datab => \ALT_INV_memROM~5_combout\,
