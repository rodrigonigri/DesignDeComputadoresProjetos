...
with open(destinoBIN, "w") as f:  #Abre o destino BIN
    ...
    for i, line in enumerate(lines): 
        ...
        #Se a linha for válida para conversão, executa
            ...
            label, line = defineLabel (line)
            if label !=None:
                labels[label] = cont
                lines[i]=line
            cont+=1
    print(labels)
    cont = 0 #Recria contador
    for line in lines:        
        ...
        #Se a linha for válida para conversão, executa
            ...
            instrucaoLine = trataMnemonicoRegs(instrucaoLine) #Trata o mnemonico. Ex(JSR @14): x"9" @14
                  
            if '@' in instrucaoLine: #Se encontrar o caractere arroba '@' 
                instrucaoLine = converteArroba(instrucaoLine, labels) #converte o número após o caractere Ex(JSR @14): x"9" x"0E"
